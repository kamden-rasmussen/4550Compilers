...
enum TokenType {
    ...
    // Other Operators:
    INSERTION_TOKEN, ASSIGNMENT_TOKEN, PLUS_TOKEN, PEQUALS_TOKEN, MINUS_TOKEN, TIMES_TOKEN, DIVIDE_TOKEN, EXPONENT_TOKEN,
    // Other Characters:
...
const string gTokenTypeNames[] = {
    ...
    "INSERTION", "ASSIGNMENT", "PLUS", "PEQUALS", "MINUS", "TIMES", "DIVIDE", "EXPONENT",
